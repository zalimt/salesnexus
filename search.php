...
<main id="main" class="site-main blog-page">
    <article class="blog-page-content">
        ...
        <section class="blog-header-section">
            <div class="container">
                <?php if (have_posts()) : ?>
                    <h1 class="blog-heading">Search Results for "<strong><?php echo get_search_query(); ?></strong>"</h1>
                    <p class="blog-subheading">Found <?php echo $wp_query->found_posts; ?> result<?php echo ($wp_query->found_posts != 1) ? 's' : ''; ?> for your search.</p>
                <?php else : ?>
                    <h1 class="blog-heading">No Results Found</h1>
                    <p class="blog-subheading">Sorry, no posts found for "<?php echo get_search_query(); ?>". Try searching for something else.</p>
                <?php endif; ?>
            ...
            <div class="container">
                ...
                <?php else : ?>
                    <div class="no-posts-message">
                        ...
                        <p>Try adjusting your search terms or browse our latest posts below.</p>
